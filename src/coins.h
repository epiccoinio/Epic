...
/** 
    ...
    ****Note - for Epic we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of epic coming in to a transaction
