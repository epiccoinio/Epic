                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Epic Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a EPIC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and epic: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Epic Core"), this);
    aboutAction->setStatusTip(tr("Show information about Epic Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Epic"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EPIC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EPIC addresses"));
    ...
    openAction->setStatusTip(tr("Open a epic: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Epic Core help message to get a list with possible Epic command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Epic Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Epic network", "", count));
}
...
{
    QString strTitle = tr("Epic Core"); // default title
